...
deleteRecord(($(this).attr("value")),"adresy_korespondencyjne");
...
if ($user->check()) { // Tylko dla użytkowników zalogowanych
    ...
    <div class="jumbotron mb-n4 bg-white">
            ...
            <form method="post" action="adresy_korespondencyjne.php"><i class="fa fa-envelope" aria-hidden="true"></i> <b>ADRESY KORESPODENCYJNE </b> <br/><span class="small" id="naglowek_dziennik"></span><span class="small" id="naglowek_dziennik2"></span>
            </div>
            <div class="col">
...
echo '</form>';
                        ...
                        echo '<table id="tabela_gl" class="table table-sm table-striped">
                              ...
                              <tr class="text-center">
                                ...
                                <th scope="col">Imię i nazwisko</th>
                                  ...
                                  <th scope="col" class="text-center dontprint no-sort"><a href="adresy_korespondencyjne_edytuj.php" role="button" class="btn btn-dark btn-sm text-uppercase"><i class="fa fa-plus" aria-hidden="true"></i> Dodaj<br/>pozycję</a>
                                  </th>
                                </tr>
                                </thead>
                              <tbody>
      ...
      echo tabeladb2('15','SELECT * FROM adresy_korespondencyjne ORDER BY `id` DESC', '<tr class="text-center">', '</tr>',
      '<td>', '0', '</td>',
      '<td>', '1', '</td>',
      '<td>', '2', '</td>',
      ...
      '', '', '',
      '<td class="small">', '6', '</td>',
      '<td class="text-center dontprint text-nowrap"><a href="adresy_korespondencyjne_edytuj.php?id=', '0', '" role="button" class="btn btn-dark btn-sm text-uppercase"><i class="fa fa-pencil" aria-hidden="true"></i> edytuj</a></td>',
