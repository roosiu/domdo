...
function filename(path){
    ...
    else if(filename(window.location.pathname)=="wydruki_lista_obecnosci" || filename(window.location.pathname)=="wydruki_karty_robot" || filename(window.location.pathname)=="wydruki_kontrola_czasu" || filename(window.location.pathname)=="wydruki_karty_wyposazenia" || filename(window.location.pathname)=="wydruki_raporty" || filename(window.location.pathname)=="wydruki_wykaz_zmian_czynszowych"){
