	...
	var methods = {
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
							  ...
							  'styles'	: { "select":true,
											"default": "Formatowanie",
											"tooltip": "Formatowanie",
							 ...
							 'font_size': {	"select":true,
							  ...
							  'color'	: { "text":"A",
											...
											"custom":function(button){
													...
													var palette       = $('<ul />',{id:"color_ui"}).append($('<li />').css({"width":"145px","display":"Block","height":"25px"}).html('<div>Kolor tekstu</div>'));
													var bgPalletteDiv = $('<div/>',{id:"bg_colorpellete"});
													var bgPallette    = $('<ul />',{id:"bgcolor_ui"}).append($('<li />').css({"width":"145px","display":"Block","height":"25px"}).html('<div>Kolor tla</div>'));
						     ...
						     'ol'		: { "text": "N",
											"icon": "fa fa-list-ol",
											"tooltip": "Wstaw/Usuń numerowanie",
											"commandname":"insertorderedlist",
											"custom":null },

						     'ul'		: { "text": "Bullet",
											"icon": "fa fa-list-ul",
											"tooltip": "Wstaw/Usuń punktory",
						   ...
						   'insert_link': { "modal": true,
											...
											"onSave":function(){
												...
												if(targetURL ==''){
													methods.showMessage.apply(editorObj,["errMsg","Wprowadź adres url"]);
													return false;
												}
						   ...
						   'insert_img'	: { "modal": true,
											...
											"tooltip": "Wstaw obrazek",
											"modalHeader": "Wstaw obrazek",
											...
											"onSave": function(){
												...
												if($('#imageList' + _idSuffix).data('current')){
													...
													methods.showMessage.apply(this,["imgErrMsg" + _idSuffix,"Zaznacz obrazek"]);
													return false;
												}
						...
						'insert_table'	: { "modal": true,
											...
											"icon":"fa fa-table",
											"tooltip": "Wstaw tabele",
											"modalHeader": "Wstaw tabele",
						   ...
						   'outdent'	: { "text": "Outdent",
							...
							'print'		: { "text": "Print",
											...
											oPrntWin.document.write("<!doctype html><html><head><title>Wydruk</title></head><body onload=\"print();\">" + oDoc.html() + "</body></html>");
											oPrntWin.document.close();
											}},

							'rm_format'	: { "text": "Remove format",
											"icon":"fa fa-eraser",
											"tooltip": "Wyczyśc formatowanie",
			...
			var statusBar = $("<div/>", {	id : "statusbar_" + $(this).attr("id"),
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").html('<div class="label">'+'Słowa : '+wordCount+'</div>');
					$(editor_Content).data("statusBar").append('<div class="label">'+'Znaki : '+charCount+'</div>');
            	});
	        }
