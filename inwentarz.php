...
if ($user->check()) { // Tylko dla użytkowników zalogowanych
    ...
    <div class="jumbotron mb-n4 bg-white">
            ...
            <form method="post" action="faktury.php"><i class="fa fa-building" aria-hidden="true"></i> <b>INWENTARZ</b> <br/><span class="small" id="naglowek_dziennik"></span><span class="small" id="naglowek_dziennik2"></span>
            </div>
            <div class="col">
