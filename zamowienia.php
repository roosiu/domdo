...
deleteRecord(($(this).attr("value")),"zamowienia");
...
if ($user->check()) { // Tylko dla użytkowników zalogowanych
    ...
    <div class="jumbotron mb-n4 bg-white">
            ...
            <i class="fa fa-shopping-cart" aria-hidden="true"></i> <b>ZAMÓWIENIA</b> <br/><span class="small" id="naglowek_dziennik"></span><span class="small" id="naglowek_dziennik2"></span>
            </div>
            <div class="col">
            </div>
            </div>
';
                        ...
                        echo '<table id="tabela_gl" class="table table-sm table-striped table-hover">
                              ...
                              <tr class="text-center">
                                ...
                                <th scope="col">Data</th>
                                  ...
                                  <th scope="col" class="text-center dontprint no-sort"><a href="zamowienia_edytuj.php" role="button" class="btn btn-dark btn-sm text-uppercase"><i class="fa fa-plus" aria-hidden="true"></i> Dodaj<br/>pozycję</a>
                                  </th>
                                </tr>
                                </thead>
                              <tbody>
      ...
      echo tabeladb2('15','SELECT * FROM zamowienia ORDER BY `id` DESC', '<tr class="text-center">', '</tr>',
      '<td>', '0', '</td>',
      '<td>', '1', '</td>',
      '<td>', '2', '</td>',
      '', '', '',
      ...
      '', '', '',
      '', '', '',
      '<td class="text-center dontprint text-nowrap"><a href="zamowienia_edytuj.php?id=', '0', '" role="button" class="btn btn-dark btn-sm text-uppercase"><i class="fa fa-pencil" aria-hidden="true"></i> edytuj</a></td>',
